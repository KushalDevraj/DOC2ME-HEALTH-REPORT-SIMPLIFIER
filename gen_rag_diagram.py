...
def gen_rag_diagram():
    ...
    plt.title('Fig 12. Generative Simplification Engine (RAG Pipeline) Workflow', fontsize=14, fontweight='bold', pad=20)
    
    os.makedirs('images', exist_ok=True)
    path = os.path.join('images', 'rag_pipeline_flowchart.jpg')
