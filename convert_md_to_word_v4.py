...
def parse_markdown(md_text, doc):
    ...
    for line in lines:
        ...
        # Headers
        if line.startswith('# '):
            # Special handling for "Chapter 1: Introduction" to switch page numbering
            if "Chapter 1: Introduction" in line:
                 section = doc.add_section()
                 # We can't easily programmatically switch from Roman to Arabic in python-docx without XML hacking
                 # But adding a section break is a good start.
...
if __name__ == "__main__":
    try:
        ...
        output_file = 'Doc2Me_Health_Report.docx'
