...
def gen_strategy_architecture():
    ...
    plt.title('Fig 13. Strategic System Architecture for Doc 2 Me', fontsize=16, fontweight='bold', pad=30)
    
    os.makedirs('images', exist_ok=True)
    path = os.path.join('images', 'strategy_architecture_diagram.jpg')
    plt.savefig(path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"Saved {path}")

if __name__ == '__main__':
    gen_strategy_architecture()
